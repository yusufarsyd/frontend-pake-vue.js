    ...
    <div class="pb-20 pt-20">
        <div class="container mx-auto grid grid-cols-1 p-3 sm:w-full md:w-5/12">
            ...
            <div class="bg-white rounded-md shadow-md p-5">
                ...
                <div class="mb-2">
                     <label class="mt-2 font-bold text-center">Minimal Donasi</label>
                     <br>
                    <div class="mt-2 grid grid-cols-4 gap-4">
                       <button class="mt-4 bg-Grey-700 py-1 rounded-md shadow-md text-base uppercase font-bold focus:outline-none focus:bg-yellow-400">Rp.20.000</button>
                        <button class="mt-4 bg-Grey-700 py-1 rounded-md shadow-md text-base uppercase font-bold focus:outline-none focus:bg-yellow-400">Rp.50.000</button>
                         <button class="mt-4 bg-Grey-700 py-1 rounded-md shadow-md text-base uppercase font-bold focus:outline-none focus:bg-yellow-400">Rp.75.000</button>
                          <button class="mt-4 bg-Grey-700 py-1 rounded-md shadow-md text-base uppercase font-bold focus:outline-none focus:bg-yellow-400">Rp.100.000</button>
    ...
    export default {
        ...
        setup() {
            ...
            function storeDonation() {
                ...
                if(donation.amount < 20000) {
                    toast.error('Donasi Minimal Rp. 20.000')
                    return false
